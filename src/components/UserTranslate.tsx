  ...
  return (
    <>
      <Text fontSize={"2xl"} my={8}>
        Your Projects in Translation Phase
      </Text>
      {data ? (
            ...
            >
              <Flex width={"100%"} justifyContent={"space-between"} alignItems={"center"}>
                ...
                <Button disabled colorScheme="purple" variant="solid" h={"1rem"} rounded="2xl" marginLeft={2}>
                  <Text fontSize={"xs"}> {(parseFloat(project.vault) / 1e18).toString().slice(1, 3)} MATIC </Text>
                </Button>
              </Flex>
              <Text fontSize={"sm"} textAlign="center">
                {project.description.slice(0, 100)}
              </Text>
              <Button colorScheme="purple" size="sm" rounded="2xl">
